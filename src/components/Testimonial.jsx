const Testimonial = () => {
    ...
    return (
        <div className="flex flex-col mt-10 items-center px-6 md:px-16 lg:px-24 pt-20 pb-30">
            <div className="flex flex-col justify-center items-center text-center">
                <h1 className="text-4xl md:text-[40px] font-bold">Our Loved Ones Review</h1>
